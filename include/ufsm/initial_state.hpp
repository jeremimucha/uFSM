...
template<typename T>
constexpr inline auto initial_state_v{initial_state_t<T>{}};

template<typename T, typename = void_t<>>
struct HasInitialStateT : std::false_type { };
template<typename T>
...
template<typename T, typename U, bool = HasInitialState<T>>
struct initial_state_or {
    using type = U;
};
template<typename T, typename U>
struct initial_state_or<T, U, true> {
    using type = typename T::InitialState;
};

template<typename T>
struct IsInitialStateTypeT : std::false_type { };
template<typename T>
