...
class Fsm<Impl, Typelist<States...>>
  : public Impl
  , public back::Fsm_impl<MakeIndexSequence<sizeof...(States)>, States...> {
    using Base = back::Fsm_impl<MakeIndexSequence<sizeof...(States)>, States...>;
    using Indices = MakeIndexSequence<sizeof...(States)>;

  public:
    using InitialState = typename initial_state_or<Impl, typename Front<Typelist<States...>>::type>::type;
      ...
      : Base{init_state}
    {
        back::fsmEntry<decltype(back::get<StateIndex<Typelist<States...>, State>>(*this)),
          ...
          back::get<StateIndex<Typelist<States...>, State>>(*this), *this, ufsm::InitialTransitionEvent{});
    }
